...
class HrssTableHeaderView: UIView {
    ...
    var menuModels:[HrssModel] = [HrssModel.init(json:JSON(["iconUrl":"ic_home_scaning","title":"扫一扫","tag":"0"])),HrssModel.init(json:JSON(["iconUrl":"ic_home_sdking","title":"电子社保卡","tag":"0"])),HrssModel.init(json:JSON(["iconUrl":"ic_home_teling","title":"","tag":"0"])),HrssModel.init(json:JSON(["iconUrl":"ic_home_msg_center","title":"消息中心","tag":"0"]))];
    var funcModels:[HrssModel] = [HrssModel.init(json:JSON(["iconUrl":"ic_home_rs_area","title":"扫一扫","tag":"1"])),HrssModel.init(json:JSON(["iconUrl":"ic_home_rs_origation","title":"电子社保卡","tag":"1"])),HrssModel.init(json:JSON(["iconUrl":"ic_home_rs_area","title":"","tag":"1"])),HrssModel.init(json:JSON(["iconUrl":"ic_home_rs_origation","title":"消息中心","tag":"1"])),HrssModel.init(json:JSON(["iconUrl":"ic_home_rs_area","title":"扫一扫","tag":"1"])),HrssModel.init(json:JSON(["iconUrl":"ic_home_rs_origation","title":"电子社保卡","tag":"1"])),HrssModel.init(json:JSON(["iconUrl":"ic_home_rs_area","title":"","tag":"1"])),HrssModel.init(json:JSON(["iconUrl":"ic_home_more_service","title":"更多服务","tag":"1"]))];
